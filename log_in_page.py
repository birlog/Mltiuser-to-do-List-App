...
class LoginGui(tk.Tk):
    ...
    def widgets_configuration(self):
        ...
        self.log_in_label = Label(
            self, text="Login Page", font=("Bradley Hand ITC", 30, "bold"))
        self.frame = Frame(self)

        self.name_label = Label(self.frame, text="User Name", font=("Dubai, 16"))
        self.name_entry = Entry(self.frame, width=15, font=("Dubai, 16"))

        self.password_label = Label(self.frame, text="Password", font=("Dubai, 16"))
        self.password_entry = Entry(self.frame, width=15, font=("Dubai, 16"))

        self.log_in_button = Button(
            self, text="Login", font=("Bradley Hand ITC", 25, "bold"))
